...
app.layout = html.Div(
    style={ 'font-family':"Courier New, monospace", 'backgroundColor':'black'},
    children=[
    html.H1('Case History of the Coronavirus (COVID-19)', style= {'font-family':"Roboto", 'marginBottom': 10, 'marginTop': 5, 'marginLeft': 10, 'color': 'blue'}),
    html.Div(className="row", children=[
        html.Div(className="four columns", children=[
            html.H5('Country', style = {'marginLeft': 10, 'color': 'blue'}),
            dcc.Dropdown( style = {'marginLeft': 10},
                id='country',
        ...
        html.Div(className="four columns", children=[
            html.H5('State / Province', style = {'color': 'blue'}),
            dcc.Dropdown(
                id='state'
            )
        ]),
        html.Div(className="four columns", children=[
            html.H5('Selected Metrics', style = {'color': 'blue'}),
            dcc.Checklist(style = {'marginBottom' : 10, 'color': 'blue'},
                id='metrics',
...
def update_plot_new_metrics(country, state, metrics):
    ...
    return barchart(data.tail(60), metrics, prefix="New", yaxisTitle="New Cases per Day")
...
def update_plot_cum_metrics(country, state, metrics):
    data = nonreactive_data(country, state)
    return barchart(data.tail(60), metrics, prefix="Cum", yaxisTitle="Cumulated Cases")
